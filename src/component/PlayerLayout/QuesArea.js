      ...
      <div className='margin_box '>
        <div className='question'>
          <Col className='user_account'>
            <h5>
              <strong>Your account :</strong> {accQues.acc.account}
            </h5>
            <p>
              <strong>Balance :</strong> {accQues.acc.balance} <strong>ETH</strong>
            </p>
          </Col>
